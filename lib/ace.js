System.register("es6/keyboard/KeyBinding.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/lib/keys.js", "es6/lib/event.js"], function (_export) {
    ...
    return {
        ...
        }, function (_es6LibKeysJs) {
            keyCodeToString = _es6LibKeysJs.keyCodeToString;
        }, function (_es6LibEventJs) {
            stopEvent = _es6LibEventJs.stopEvent;
        }],
        execute: function () {
            "use strict";
            ...
            KeyBinding = (function () {
                ...
                _createClass(KeyBinding, [{
                    ...
                    value: function addKeyboardHandler(kb, pos) {
                        ...
                        if (pos === void 0) this.$handlers.push(kb);else this.$handlers.splice(pos, 0, kb);
...
System.register("es6/keyboard/TextInput.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/lib/event.js", "es6/lib/useragent.js", "es6/lib/dom.js", "es6/lib/lang.js"], function (_export) {
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersCreateClass) {
            ...
            addCommandKeyListener = _es6LibEventJs.addCommandKeyListener;
            addListener = _es6LibEventJs.addListener;
            capture = _es6LibEventJs.capture;
            preventDefault = _es6LibEventJs.preventDefault;
        }, function (_es6LibUseragentJs) {
            isChrome = _es6LibUseragentJs.isChrome;
            isGecko = _es6LibUseragentJs.isGecko;
            isIE = _es6LibUseragentJs.isIE;
            isMac = _es6LibUseragentJs.isMac;
            isOldIE = _es6LibUseragentJs.isOldIE;
            isTouchPad = _es6LibUseragentJs.isTouchPad;
            isWebKit = _es6LibUseragentJs.isWebKit;
            isWin = _es6LibUseragentJs.isWin;
        }, function (_es6LibDomJs) {
            createElement = _es6LibDomJs.createElement;
        }, function (_es6LibLangJs) {
            delayedCall = _es6LibLangJs.delayedCall;
        }],
        execute: function () {
            "use strict";
            ...
            TextInput = (function () {
                function TextInput(parentNode, host) {
                    ...
                    this.moveToMouse = function (e, bringToFront) {
                        ...
                        if (isWin) capture(host.container, move, onContextMenuClose);
                    };
...
System.register("es6/Search.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/lib/lang.js", "es6/lib/oop.js", "es6/Range.js"], function (_export) {
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersCreateClass) {
            ...
            copyObject = _es6LibLangJs.copyObject;
            escapeRegExp = _es6LibLangJs.escapeRegExp;
            getMatchOffsets = _es6LibLangJs.getMatchOffsets;
        }, function (_es6LibOopJs) {
            mixin = _es6LibOopJs.mixin;
        }, function (_es6RangeJs) {
            Range = _es6RangeJs["default"];
        }],
        execute: function () {
            "use strict";
...
System.register("es6/lib/mix.js", ["npm:babel-runtime@5.8.34/core-js/object/get-own-property-names"], function (_export) {
...
System.register("es6/keyboard/HashHandler.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "npm:babel-runtime@5.8.34/core-js/object/keys", "es6/lib/keys.js", "es6/lib/useragent.js"], function (_export) {
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersCreateClass) {
            ...
            FUNCTION_KEYS = _es6LibKeysJs.FUNCTION_KEYS;
            KEY_MODS = _es6LibKeysJs.KEY_MODS;
            keyCodes = _es6LibKeysJs["default"];
        }, function (_es6LibUseragentJs) {
            isMac = _es6LibUseragentJs.isMac;
        }],
        execute: function () {
...
System.register("es6/commands/CommandManager.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/lib/mix.js", "es6/keyboard/HashHandler.js", "es6/lib/event_emitter.js"], function (_export) {
    var _get, _inherits, _createClass, _classCallCheck, applyMixins, HashHandler, EventEmitterClass, CommandManager;
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersGet) {
            ...
            _classCallCheck = _npmBabelRuntime5834HelpersClassCallCheck["default"];
        }, function (_es6LibMixJs) {
            applyMixins = _es6LibMixJs.applyMixins;
        }, function (_es6KeyboardHashHandlerJs) {
            HashHandler = _es6KeyboardHashHandlerJs["default"];
        }, function (_es6LibEvent_emitterJs) {
            EventEmitterClass = _es6LibEvent_emitterJs["default"];
        }],
        execute: function () {
            "use strict";

            CommandManager = (function (_EventEmitterClass) {
                _inherits(CommandManager, _EventEmitterClass);

                function CommandManager(platform, commands) {
                    _classCallCheck(this, CommandManager);

                    _get(Object.getPrototypeOf(CommandManager.prototype), "constructor", this).call(this);
...
System.register("es6/commands/default_commands.js", ["es6/lib/lang.js", "es6/config.js", "es6/Range.js"], function (_export) {
    "use strict";
    ...
    return {
        setters: [function (_es6LibLangJs) {
            stringRepeat = _es6LibLangJs.stringRepeat;
            stringTrimLeft = _es6LibLangJs.stringTrimLeft;
            stringTrimRight = _es6LibLangJs.stringTrimRight;
        }, function (_es6ConfigJs) {
            loadModule = _es6ConfigJs.loadModule;
        }, function (_es6RangeJs) {
            Range = _es6RangeJs["default"];
        }],
        execute: function () {
...
System.register("es6/editor_protocol.js", [], function (_export) {
  "use strict";
...
System.register("es6/hammer/recognizers/attribute.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/hammer/hammer.js"], function (_export) {
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersGet) {
            ...
            _classCallCheck = _npmBabelRuntime5834HelpersClassCallCheck["default"];
        }, function (_es6HammerHammerJs) {
            decodeEventType = _es6HammerHammerJs.decodeEventType;
            INPUT_CANCEL = _es6HammerHammerJs.INPUT_CANCEL;
            INPUT_END = _es6HammerHammerJs.INPUT_END;
            INPUT_MOVE = _es6HammerHammerJs.INPUT_MOVE;
            INPUT_START = _es6HammerHammerJs.INPUT_START;
            Recognizer = _es6HammerHammerJs.Recognizer;
            STATE_BEGAN = _es6HammerHammerJs.STATE_BEGAN;
            STATE_CANCELLED = _es6HammerHammerJs.STATE_CANCELLED;
            STATE_CHANGED = _es6HammerHammerJs.STATE_CHANGED;
            STATE_FAILED = _es6HammerHammerJs.STATE_FAILED;
            STATE_RECOGNIZED = _es6HammerHammerJs.STATE_RECOGNIZED;
        }],
        execute: function () {
            "use strict";
...
System.register('es6/hammer/recognizers/pan.js', ['npm:babel-runtime@5.8.34/helpers/get', 'npm:babel-runtime@5.8.34/helpers/inherits', 'npm:babel-runtime@5.8.34/helpers/create-class', 'npm:babel-runtime@5.8.34/helpers/class-call-check', 'es6/hammer/recognizers/attribute.js', 'es6/hammer/hammer.js'], function (_export) {
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersGet) {
            ...
            _classCallCheck = _npmBabelRuntime5834HelpersClassCallCheck['default'];
        }, function (_es6HammerRecognizersAttributeJs) {
            ContinuousRecognizer = _es6HammerRecognizersAttributeJs.ContinuousRecognizer;
        }, function (_es6HammerHammerJs) {
            DIRECTION_ALL = _es6HammerHammerJs.DIRECTION_ALL;
            DIRECTION_DOWN = _es6HammerHammerJs.DIRECTION_DOWN;
            DIRECTION_HORIZONTAL = _es6HammerHammerJs.DIRECTION_HORIZONTAL;
            DIRECTION_LEFT = _es6HammerHammerJs.DIRECTION_LEFT;
            DIRECTION_RIGHT = _es6HammerHammerJs.DIRECTION_RIGHT;
            DIRECTION_UNDEFINED = _es6HammerHammerJs.DIRECTION_UNDEFINED;
            DIRECTION_UP = _es6HammerHammerJs.DIRECTION_UP;
            DIRECTION_VERTICAL = _es6HammerHammerJs.DIRECTION_VERTICAL;
            STATE_BEGAN = _es6HammerHammerJs.STATE_BEGAN;
            TOUCH_ACTION_PAN_X = _es6HammerHammerJs.TOUCH_ACTION_PAN_X;
            TOUCH_ACTION_PAN_Y = _es6HammerHammerJs.TOUCH_ACTION_PAN_Y;
        }],
        execute: function () {
            "use strict";
...
System.register('es6/hammer/hammer.js', ['npm:babel-runtime@5.8.34/helpers/create-class', 'npm:babel-runtime@5.8.34/helpers/class-call-check', 'npm:babel-runtime@5.8.34/helpers/get', 'npm:babel-runtime@5.8.34/helpers/inherits', 'es6/hammer/utils.js'], function (_export) {
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersCreateClass) {
            ...
            _inherits = _npmBabelRuntime5834HelpersInherits['default'];
        }, function (_es6HammerUtilsJs) {
            addEventListeners = _es6HammerUtilsJs.addEventListeners;
            each = _es6HammerUtilsJs.each;
            getWindowForElement = _es6HammerUtilsJs.getWindowForElement;
            hasParent = _es6HammerUtilsJs.hasParent;
            inArray = _es6HammerUtilsJs.inArray;
            inStr = _es6HammerUtilsJs.inStr;
            prefixed = _es6HammerUtilsJs.prefixed;
            removeEventListeners = _es6HammerUtilsJs.removeEventListeners;
            splitStr = _es6HammerUtilsJs.splitStr;
            TEST_ELEMENT = _es6HammerUtilsJs.TEST_ELEMENT;
            toArray = _es6HammerUtilsJs.toArray;
            uniqueArray = _es6HammerUtilsJs.uniqueArray;
            uniqueId = _es6HammerUtilsJs.uniqueId;
        }],
        execute: function () {
            "use strict";
...
System.register('es6/hammer/utils.js', ['npm:babel-runtime@5.8.34/core-js/object/keys', 'npm:babel-runtime@5.8.34/core-js/object/create'], function (_export) {
...
System.register('es6/hammer/recognizers/tap.js', ['npm:babel-runtime@5.8.34/helpers/get', 'npm:babel-runtime@5.8.34/helpers/inherits', 'npm:babel-runtime@5.8.34/helpers/create-class', 'npm:babel-runtime@5.8.34/helpers/class-call-check', 'es6/hammer/hammer.js', 'es6/hammer/utils.js'], function (_export) {
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersGet) {
            ...
            decodeEventType = _es6HammerHammerJs.decodeEventType;
            getDistance = _es6HammerHammerJs.getDistance;
            INPUT_START = _es6HammerHammerJs.INPUT_START;
            INPUT_MOVE = _es6HammerHammerJs.INPUT_MOVE;
            INPUT_END = _es6HammerHammerJs.INPUT_END;
            INPUT_CANCEL = _es6HammerHammerJs.INPUT_CANCEL;
            ...
            STATE_FAILED = _es6HammerHammerJs.STATE_FAILED;
            STATE_RECOGNIZED = _es6HammerHammerJs.STATE_RECOGNIZED;
            TOUCH_ACTION_MANIPULATION = _es6HammerHammerJs.TOUCH_ACTION_MANIPULATION;
        }, function (_es6HammerUtilsJs) {
            setTimeoutContext = _es6HammerUtilsJs.setTimeoutContext;
        }],
        execute: function () {
            "use strict";
...
System.register('es6/touch/touch.js', ['es6/hammer/hammer.js', 'es6/hammer/recognizers/pan.js', 'es6/hammer/recognizers/tap.js'], function (_export) {
    'use strict';
    ...
    return {
        setters: [function (_es6HammerHammerJs) {
            DIRECTION_VERTICAL = _es6HammerHammerJs.DIRECTION_VERTICAL;
            Manager = _es6HammerHammerJs.Manager;
        }, function (_es6HammerRecognizersPanJs) {
            PanRecognizer = _es6HammerRecognizersPanJs.PanRecognizer;
        }, function (_es6HammerRecognizersTapJs) {
            TapRecognizer = _es6HammerRecognizersTapJs.TapRecognizer;
        }],
        execute: function () {}
    };
});
System.register("es6/Tooltip.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/lib/dom.js"], function (_export) {
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersCreateClass) {
            ...
            addCssClass = _es6LibDomJs.addCssClass;
            createElement = _es6LibDomJs.createElement;
            setInnerText = _es6LibDomJs.setInnerText;
        }],
        execute: function () {
            "use strict";
...
System.register("es6/Editor.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/lib/oop.js", "es6/lib/dom.js", "es6/lib/lang.js", "es6/lib/useragent.js", "es6/keyboard/KeyBinding.js", "es6/keyboard/TextInput.js", "es6/Search.js", "es6/Range.js", "es6/lib/event_emitter.js", "es6/commands/CommandManager.js", "es6/commands/default_commands.js", "es6/config.js", "es6/TokenIterator.js", "es6/editor_protocol.js", "es6/lib/event.js", "es6/touch/touch.js", "es6/Tooltip.js"], function (_export) {
    var _get, _inherits, _createClass, _classCallCheck, mixin, computedStyle, hasCssClass, setCssClass, delayedCall, stringRepeat, isIE, isMac, isMobile, isOldIE, isWebKit, KeyBinding, TextInput, Search, Range, EventEmitterClass, CommandManager, defaultCommands, defineOptions, loadModule, resetOptions, TokenIterator, COMMAND_NAME_AUTO_COMPLETE, addListener, addMouseWheelListener, addMultiMouseDownListener, capture, _getButton, _preventDefault, stopEvent, _stopPropagation, touchManager, Tooltip, Editor, FoldHandler, MouseHandler, EditorMouseEvent, DRAG_OFFSET, GutterHandler, GutterTooltip;
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersGet) {
            ...
            computedStyle = _es6LibDomJs.computedStyle;
            hasCssClass = _es6LibDomJs.hasCssClass;
            setCssClass = _es6LibDomJs.setCssClass;
        }, function (_es6LibLangJs) {
            delayedCall = _es6LibLangJs.delayedCall;
            stringRepeat = _es6LibLangJs.stringRepeat;
        }, function (_es6LibUseragentJs) {
            isIE = _es6LibUseragentJs.isIE;
            isMac = _es6LibUseragentJs.isMac;
            isMobile = _es6LibUseragentJs.isMobile;
            isOldIE = _es6LibUseragentJs.isOldIE;
            isWebKit = _es6LibUseragentJs.isWebKit;
        }, function (_es6KeyboardKeyBindingJs) {
            KeyBinding = _es6KeyboardKeyBindingJs["default"];
        }, function (_es6KeyboardTextInputJs) {
            TextInput = _es6KeyboardTextInputJs["default"];
        }, function (_es6SearchJs) {
            Search = _es6SearchJs["default"];
        }, function (_es6RangeJs) {
            Range = _es6RangeJs["default"];
        }, function (_es6LibEvent_emitterJs) {
            EventEmitterClass = _es6LibEvent_emitterJs["default"];
        }, function (_es6CommandsCommandManagerJs) {
            CommandManager = _es6CommandsCommandManagerJs["default"];
        }, function (_es6CommandsDefault_commandsJs) {
            defaultCommands = _es6CommandsDefault_commandsJs["default"];
        }, function (_es6ConfigJs) {
            defineOptions = _es6ConfigJs.defineOptions;
            loadModule = _es6ConfigJs.loadModule;
            resetOptions = _es6ConfigJs.resetOptions;
        }, function (_es6TokenIteratorJs) {
            TokenIterator = _es6TokenIteratorJs["default"];
        }, function (_es6Editor_protocolJs) {
            COMMAND_NAME_AUTO_COMPLETE = _es6Editor_protocolJs.COMMAND_NAME_AUTO_COMPLETE;
        }, function (_es6LibEventJs) {
            addListener = _es6LibEventJs.addListener;
            addMouseWheelListener = _es6LibEventJs.addMouseWheelListener;
            addMultiMouseDownListener = _es6LibEventJs.addMultiMouseDownListener;
            capture = _es6LibEventJs.capture;
            _getButton = _es6LibEventJs.getButton;
            _preventDefault = _es6LibEventJs.preventDefault;
            stopEvent = _es6LibEventJs.stopEvent;
            _stopPropagation = _es6LibEventJs.stopPropagation;
        }, function (_es6TouchTouchJs) {
            touchManager = _es6TouchTouchJs.touchManager;
        }, function (_es6TooltipJs) {
            Tooltip = _es6TooltipJs["default"];
        }],
        execute: function () {
            "use strict";

            Editor = (function (_EventEmitterClass) {
                _inherits(Editor, _EventEmitterClass);
                ...
                _createClass(Editor, [{
                    ...
                    key: "startOperation",
                    value: function startOperation(commadEvent) {
                        if (this.curOp) {
                    ...
                    value: function onDocumentChange(e, editSession) {
                        var delta = e.data;
                    ...
                    value: function onTokenizerUpdate(event, editSession) {
                        var rows = event.data;
                        this.renderer.updateLines(rows.first, rows.last);
                    }
                }, {
                    key: "onScrollTopChange",
                    value: function onScrollTopChange(event, editSession) {
                        this.renderer.scrollToY(this.session.getScrollTop());
                    }
                }, {
                    key: "onScrollLeftChange",
                    value: function onScrollLeftChange(event, editSession) {
                        this.renderer.scrollToX(this.session.getScrollLeft());
                    }
                }, {
                    key: "onCursorChange",
                    value: function onCursorChange(event, editSession) {
                        this.$cursorChange();
                    ...
                    value: function onChangeFrontMarker(event, editSession) {
                        this.renderer.updateFrontMarkers();
                    }
                }, {
                    key: "onChangeBackMarker",
                    value: function onChangeBackMarker(event, editSession) {
                    ...
                    value: function onChangeAnnotation(event, editSession) {
                        this.renderer.setAnnotations(editSession.getAnnotations());
                        this._emit("changeAnnotation", event);
                    }
                }, {
                    key: "onChangeMode",
                    value: function onChangeMode(event, editSession) {
                        this.renderer.updateText();
                        this._emit("changeMode", event);
                    }
                }, {
                    key: "onChangeWrapLimit",
                    value: function onChangeWrapLimit(event, editSession) {
                        this.renderer.updateFull();
                    }
                }, {
                    key: "onChangeWrapMode",
                    value: function onChangeWrapMode(event, editSession) {
                        this.renderer.onResize(true);
                    }
                }, {
                    key: "onChangeFold",
                    value: function onChangeFold(event, editSession) {
                        this.$updateHighlightActiveLine();
                        this.renderer.updateFull();
                    }
                }, {
...
System.register("es6/FoldLine.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/Range.js"], function (_export) {
...
System.register("es6/comparePoints.js", [], function (_export) {
    "use strict";
...
System.register('es6/range_list.js', ['npm:babel-runtime@5.8.34/helpers/create-class', 'npm:babel-runtime@5.8.34/helpers/class-call-check', 'es6/comparePoints.js'], function (_export) {
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersCreateClass) {
            ...
            _classCallCheck = _npmBabelRuntime5834HelpersClassCallCheck['default'];
        }, function (_es6ComparePointsJs) {
            comparePoints = _es6ComparePointsJs['default'];
        }],
        execute: function () {
            'use strict';
...
System.register("es6/Fold.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/range_list.js"], function (_export) {
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersGet) {
            ...
            _classCallCheck = _npmBabelRuntime5834HelpersClassCallCheck["default"];
        }, function (_es6Range_listJs) {
            RangeList = _es6Range_listJs.RangeList;
        }],
        execute: function () {
            "use strict";
...
System.register("es6/Selection.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/lib/lang.js", "es6/lib/event_emitter.js", "es6/Range.js"], function (_export) {
    var _get, _inherits, _createClass, _classCallCheck, stringReverse, EventEmitterClass, Range, Selection;
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersGet) {
            ...
            stringReverse = _es6LibLangJs.stringReverse;
        }, function (_es6LibEvent_emitterJs) {
            EventEmitterClass = _es6LibEvent_emitterJs["default"];
        }, function (_es6RangeJs) {
            Range = _es6RangeJs["default"];
        ...
        execute: function () {
            ...
            Selection = (function (_EventEmitterClass) {
                _inherits(Selection, _EventEmitterClass);

                function Selection(session) {
                    _classCallCheck(this, Selection);

                    _get(Object.getPrototypeOf(Selection.prototype), "constructor", this).call(this);
                    this.session = session;
...
System.register('es6/Anchor.js', ['npm:babel-runtime@5.8.34/helpers/get', 'npm:babel-runtime@5.8.34/helpers/inherits', 'npm:babel-runtime@5.8.34/helpers/create-class', 'npm:babel-runtime@5.8.34/helpers/class-call-check', 'es6/lib/event_emitter.js', 'es6/lib/asserts.js'], function (_export) {
    var _get, _inherits, _createClass, _classCallCheck, EventEmitterClass, assert, Anchor;
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersGet) {
            ...
            EventEmitterClass = _es6LibEvent_emitterJs['default'];
        }, function (_es6LibAssertsJs) {
            assert = _es6LibAssertsJs.assert;
        }],
        execute: function () {
            "use strict";

            Anchor = (function (_EventEmitterClass) {
                _inherits(Anchor, _EventEmitterClass);
...
System.register('es6/Document.js', ['npm:babel-runtime@5.8.34/helpers/get', 'npm:babel-runtime@5.8.34/helpers/inherits', 'npm:babel-runtime@5.8.34/helpers/create-class', 'npm:babel-runtime@5.8.34/helpers/class-call-check', 'es6/Anchor.js', 'es6/lib/event_emitter.js', 'es6/Range.js'], function (_export) {
    var _get, _inherits, _createClass, _classCallCheck, Anchor, EventEmitterClass, Range, $split, Document;
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersGet) {
            ...
            _classCallCheck = _npmBabelRuntime5834HelpersClassCallCheck['default'];
        }, function (_es6AnchorJs) {
            Anchor = _es6AnchorJs['default'];
        }, function (_es6LibEvent_emitterJs) {
            EventEmitterClass = _es6LibEvent_emitterJs['default'];
        }, function (_es6RangeJs) {
            Range = _es6RangeJs['default'];
        ...
        execute: function () {
            ...
            Document = (function (_EventEmitterClass) {
                _inherits(Document, _EventEmitterClass);
...
System.register("es6/BackgroundTokenizer.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/lib/event_emitter.js"], function (_export) {
    var _get, _inherits, _createClass, _classCallCheck, EventEmitterClass, BackgroundTokenizer;
    ...
    return {
        ...
        execute: function () {
            ...
            BackgroundTokenizer = (function (_EventEmitterClass) {
                _inherits(BackgroundTokenizer, _EventEmitterClass);

                function BackgroundTokenizer(tokenizer, session) {
                    _classCallCheck(this, BackgroundTokenizer);

                    _get(Object.getPrototypeOf(BackgroundTokenizer.prototype), "constructor", this).call(this);
                    this.running = 0;
                    this.lines = [];
                    this.states = [];
                    this.currentLine = 0;
...
System.register("es6/SearchHighlight.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/lib/lang.js", "es6/Range.js"], function (_export) {
...
System.register('es6/lib/asserts.js', ['npm:babel-runtime@5.8.34/helpers/class-call-check'], function (_export) {
...
System.register("es6/BracketMatch.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/TokenIterator.js", "es6/Range.js"], function (_export) {
...
System.register("es6/Tokenizer.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check"], function (_export) {
...
System.register("es6/mode/TextHighlightRules.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "npm:babel-runtime@5.8.34/core-js/object/keys", "npm:babel-runtime@5.8.34/core-js/object/create", "es6/lib/lang.js"], function (_export) {
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersCreateClass) {
            ...
            deepCopy = _es6LibLangJs.deepCopy;
        }],
        execute: function () {
            "use strict";
...
System.register("es6/mode/Behaviour.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check"], function (_export) {
...
System.register("es6/unicode.js", [], function (_export) {
    "use strict";
    var packages;
...
System.register("es6/TokenIterator.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check"], function (_export) {
...
System.register("es6/mode/TextMode.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "npm:babel-runtime@5.8.34/core-js/promise", "es6/Tokenizer.js", "es6/mode/TextHighlightRules.js", "es6/mode/Behaviour.js", "es6/unicode.js", "es6/lib/lang.js", "es6/TokenIterator.js", "es6/Range.js"], function (_export) {
    ...
    return {
        ...
        }, function (_es6TokenizerJs) {
            Tokenizer = _es6TokenizerJs["default"];
        }, function (_es6ModeTextHighlightRulesJs) {
            TextHighlightRules = _es6ModeTextHighlightRulesJs["default"];
        }, function (_es6ModeBehaviourJs) {
            Behaviour = _es6ModeBehaviourJs["default"];
        }, function (_es6UnicodeJs) {
            packages = _es6UnicodeJs.packages;
        }, function (_es6LibLangJs) {
            escapeRegExp = _es6LibLangJs.escapeRegExp;
        }, function (_es6TokenIteratorJs) {
            TokenIterator = _es6TokenIteratorJs["default"];
...
System.register("es6/EditSession.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "npm:babel-runtime@5.8.34/core-js/promise", "npm:babel-runtime@5.8.34/core-js/object/keys", "es6/lib/lang.js", "es6/config.js", "es6/lib/event_emitter.js", "es6/FoldLine.js", "es6/Fold.js", "es6/Selection.js", "es6/Range.js", "es6/Document.js", "es6/BackgroundTokenizer.js", "es6/SearchHighlight.js", "es6/lib/asserts.js", "es6/BracketMatch.js", "es6/TokenIterator.js", "es6/mode/TextMode.js"], function (_export) {
    var _get, _inherits, _createClass, _classCallCheck, _Promise, _Object$keys, delayedCall, stringRepeat, defineOptions, resetOptions, EventEmitterClass, FoldLine, Fold, Selection, Range, Document, BackgroundTokenizer, SearchHighlight, assert, BracketMatch, TokenIterator, TextMode, CHAR, CHAR_EXT, PLACEHOLDER_START, PLACEHOLDER_BODY, PUNCTUATION, SPACE, TAB, TAB_SPACE, EditSession;
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersGet) {
            ...
            EventEmitterClass = _es6LibEvent_emitterJs["default"];
        }, function (_es6FoldLineJs) {
            FoldLine = _es6FoldLineJs["default"];
        }, function (_es6FoldJs) {
            Fold = _es6FoldJs["default"];
        }, function (_es6SelectionJs) {
            Selection = _es6SelectionJs["default"];
        }, function (_es6RangeJs) {
            Range = _es6RangeJs["default"];
        }, function (_es6DocumentJs) {
            Document = _es6DocumentJs["default"];
        }, function (_es6BackgroundTokenizerJs) {
            BackgroundTokenizer = _es6BackgroundTokenizerJs["default"];
        }, function (_es6SearchHighlightJs) {
            SearchHighlight = _es6SearchHighlightJs["default"];
        }, function (_es6LibAssertsJs) {
            assert = _es6LibAssertsJs.assert;
        }, function (_es6BracketMatchJs) {
            BracketMatch = _es6BracketMatchJs["default"];
        }, function (_es6TokenIteratorJs) {
            TokenIterator = _es6TokenIteratorJs["default"];
        }, function (_es6ModeTextModeJs) {
            TextMode = _es6ModeTextModeJs["default"];
        }],
        execute: function () {
            "use strict";
            ...
            EditSession = (function (_EventEmitterClass) {
                _inherits(EditSession, _EventEmitterClass);

                function EditSession(doc) {
                    _classCallCheck(this, EditSession);

                    _get(Object.getPrototypeOf(EditSession.prototype), "constructor", this).call(this);
                    this.$breakpoints = [];
                    this.$decorations = [];
                    this.$frontMarkers = {};
                    this.$backMarkers = {};
...
System.register("es6/UndoManager.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check"], function (_export) {
...
System.register('es6/lib/net.js', ['es6/lib/dom.js'], function (_export) {
    'use strict';
    ...
    return {
        setters: [function (_es6LibDomJs) {
            getDocumentHead = _es6LibDomJs.getDocumentHead;
        }],
        execute: function () {
            ;
        }
...
System.register("es6/config.js", ["npm:babel-runtime@5.8.34/core-js/object/keys", "es6/lib/lang.js", "es6/lib/oop.js", "es6/lib/net.js"], function (_export) {
    ...
    return {
        setters: [function (_npmBabelRuntime5834CoreJsObjectKeys) {
            ...
            implement = _es6LibOopJs.implement;
        }, function (_es6LibNetJs) {
            loadScript = _es6LibNetJs.loadScript;
        }],
        execute: function () {
            "use strict";
...
System.register("es6/layer/Gutter.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/lib/dom.js", "es6/lib/lang.js", "es6/lib/event_emitter.js"], function (_export) {
    var _get, _inherits, _createClass, _classCallCheck, addCssClass, createElement, removeCssClass, escapeHTML, EventEmitterClass, Gutter;
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersGet) {
            ...
            addCssClass = _es6LibDomJs.addCssClass;
            createElement = _es6LibDomJs.createElement;
            removeCssClass = _es6LibDomJs.removeCssClass;
        }, function (_es6LibLangJs) {
            escapeHTML = _es6LibLangJs.escapeHTML;
        }, function (_es6LibEvent_emitterJs) {
            EventEmitterClass = _es6LibEvent_emitterJs["default"];
        }],
        execute: function () {
            ...
            Gutter = (function (_EventEmitterClass) {
                _inherits(Gutter, _EventEmitterClass);
...
System.register("es6/Range.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check"], function (_export) {
...
System.register("es6/layer/Marker.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/Range.js", "es6/lib/dom.js"], function (_export) {
...
System.register("es6/layer/Text.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/lib/dom.js", "es6/lib/lang.js", "es6/lib/event_emitter.js"], function (_export) {
    var _get, _inherits, _createClass, _classCallCheck, createElement, stringRepeat, EventEmitterClass, Text;
    ...
    return {
        ...
        execute: function () {
            ...
            Text = (function (_EventEmitterClass) {
                _inherits(Text, _EventEmitterClass);
...
System.register("es6/layer/Cursor.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/lib/dom.js"], function (_export) {
...
System.register("es6/VScrollBar.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/lib/event.js", "es6/ScrollBar.js", "es6/lib/dom.js"], function (_export) {
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersGet) {
            ...
            addListener = _es6LibEventJs.addListener;
        }, function (_es6ScrollBarJs) {
            ScrollBar = _es6ScrollBarJs["default"];
        }, function (_es6LibDomJs) {
            scrollbarWidth = _es6LibDomJs.scrollbarWidth;
        }],
        execute: function () {
            "use strict";
...
System.register("es6/ScrollBar.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/lib/dom.js", "es6/lib/event.js", "es6/lib/event_emitter.js"], function (_export) {
    var _get, _inherits, _createClass, _classCallCheck, createElement, addListener, preventDefault, EventEmitterClass, ScrollBar;
    ...
    return {
        ...
        execute: function () {
            ...
            ScrollBar = (function (_EventEmitterClass) {
                _inherits(ScrollBar, _EventEmitterClass);

                function ScrollBar(parent, classSuffix) {
                    _classCallCheck(this, ScrollBar);

                    _get(Object.getPrototypeOf(ScrollBar.prototype), "constructor", this).call(this);
                    this.element = createElement("div");
...
System.register("es6/HScrollBar.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/lib/event.js", "es6/ScrollBar.js"], function (_export) {
...
System.register("es6/lib/oop.js", ["npm:babel-runtime@5.8.34/core-js/object/create"], function (_export) {
    var _Object$create;
...
System.register('es6/lib/keys.js', ['es6/lib/oop.js'], function (_export) {
    "use strict";
...
System.register('es6/lib/event.js', ['npm:babel-runtime@5.8.34/core-js/object/create', 'es6/lib/keys.js', 'es6/lib/useragent.js'], function (_export) {
    ...
    return {
        setters: [function (_npmBabelRuntime5834CoreJsObjectCreate) {
            ...
            FUNCTION_KEYS = _es6LibKeysJs.FUNCTION_KEYS;
            KEY_MODS = _es6LibKeysJs.KEY_MODS;
            MODIFIER_KEYS = _es6LibKeysJs.MODIFIER_KEYS;
            PRINTABLE_KEYS = _es6LibKeysJs.PRINTABLE_KEYS;
        }, function (_es6LibUseragentJs) {
            isChromeOS = _es6LibUseragentJs.isChromeOS;
            isIE = _es6LibUseragentJs.isIE;
            isMac = _es6LibUseragentJs.isMac;
            isOldGecko = _es6LibUseragentJs.isOldGecko;
            isOldIE = _es6LibUseragentJs.isOldIE;
            isOpera = _es6LibUseragentJs.isOpera;
        }],
        execute: function () {
            'use strict';
...
System.register("es6/RenderLoop.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "es6/lib/event.js"], function (_export) {
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersCreateClass) {
            ...
            requestAnimationFrame = _es6LibEventJs.requestAnimationFrame;
        }],
        execute: function () {
            "use strict";
...
System.register("es6/lib/dom.js", [], function (_export) {
    "use strict";
...
System.register("es6/lib/lang.js", ["npm:babel-runtime@5.8.34/core-js/object/create"], function (_export) {
...
System.register("es6/lib/useragent.js", [], function (_export) {
    "use strict";
...
System.register("es6/layer/FontMetrics.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "npm:babel-runtime@5.8.34/core-js/object/create", "es6/lib/dom.js", "es6/lib/lang.js", "es6/lib/useragent.js", "es6/lib/event_emitter.js"], function (_export) {
    var _get, _inherits, _createClass, _classCallCheck, _Object$create, createElement, stringRepeat, isIE, EventEmitterClass, CHAR_COUNT, FontMetrics;
    ...
    return {
        ...
        execute: function () {
            ...
            FontMetrics = (function (_EventEmitterClass) {
                _inherits(FontMetrics, _EventEmitterClass);

                function FontMetrics(container, pollingInterval) {
                    _classCallCheck(this, FontMetrics);

                    _get(Object.getPrototypeOf(FontMetrics.prototype), "constructor", this).call(this);
...
System.register("es6/lib/event_emitter.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check"], function (_export) {
...
System.register("es6/ThemeLink.js", ["npm:babel-runtime@5.8.34/helpers/class-call-check"], function (_export) {
...
System.register("es6/VirtualRenderer.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "npm:babel-runtime@5.8.34/core-js/promise", "es6/lib/dom.js", "es6/config.js", "es6/lib/useragent.js", "es6/layer/Gutter.js", "es6/layer/Marker.js", "es6/layer/Text.js", "es6/layer/Cursor.js", "es6/VScrollBar.js", "es6/HScrollBar.js", "es6/RenderLoop.js", "es6/layer/FontMetrics.js", "es6/lib/event_emitter.js", "es6/ThemeLink.js"], function (_export) {
    var _get, _inherits, _createClass, _classCallCheck, _Promise, _addCssClass, appendHTMLLinkElement, createElement, ensureHTMLStyleElement, removeCssClass, _setCssClass, defineOptions, resetOptions, isOldIE, Gutter, Marker, Text, Cursor, VScrollBar, HScrollBar, RenderLoop, FontMetrics, EventEmitterClass, ThemeLink, CHANGE_CURSOR, CHANGE_MARKER, CHANGE_GUTTER, CHANGE_SCROLL, CHANGE_LINES, CHANGE_TEXT, CHANGE_SIZE, CHANGE_MARKER_BACK, CHANGE_MARKER_FRONT, CHANGE_FULL, CHANGE_H_SCROLL, VirtualRenderer;
    ...
    return {
        setters: [function (_npmBabelRuntime5834HelpersGet) {
            ...
            _addCssClass = _es6LibDomJs.addCssClass;
            appendHTMLLinkElement = _es6LibDomJs.appendHTMLLinkElement;
            createElement = _es6LibDomJs.createElement;
            ensureHTMLStyleElement = _es6LibDomJs.ensureHTMLStyleElement;
            removeCssClass = _es6LibDomJs.removeCssClass;
            _setCssClass = _es6LibDomJs.setCssClass;
        }, function (_es6ConfigJs) {
            defineOptions = _es6ConfigJs.defineOptions;
            resetOptions = _es6ConfigJs.resetOptions;
        }, function (_es6LibUseragentJs) {
            isOldIE = _es6LibUseragentJs.isOldIE;
        }, function (_es6LayerGutterJs) {
            Gutter = _es6LayerGutterJs["default"];
        }, function (_es6LayerMarkerJs) {
            Marker = _es6LayerMarkerJs["default"];
        }, function (_es6LayerTextJs) {
            Text = _es6LayerTextJs["default"];
        }, function (_es6LayerCursorJs) {
            Cursor = _es6LayerCursorJs["default"];
        }, function (_es6VScrollBarJs) {
            VScrollBar = _es6VScrollBarJs["default"];
        }, function (_es6HScrollBarJs) {
            HScrollBar = _es6HScrollBarJs["default"];
        }, function (_es6RenderLoopJs) {
            RenderLoop = _es6RenderLoopJs["default"];
        }, function (_es6LayerFontMetricsJs) {
            FontMetrics = _es6LayerFontMetricsJs["default"];
        }, function (_es6LibEvent_emitterJs) {
            EventEmitterClass = _es6LibEvent_emitterJs["default"];
        }, function (_es6ThemeLinkJs) {
            ThemeLink = _es6ThemeLinkJs["default"];
        }],
        execute: function () {
            "use strict";
            CHANGE_CURSOR = 1;
            ...
            VirtualRenderer = (function (_EventEmitterClass) {
                _inherits(VirtualRenderer, _EventEmitterClass);

                function VirtualRenderer(container) {
                    _classCallCheck(this, VirtualRenderer);

                    _get(Object.getPrototypeOf(VirtualRenderer.prototype), "constructor", this).call(this);
                    this.scrollLeft = 0;
                    this.scrollTop = 0;
                    this.layerConfig = {
                        width: 1,
                ...
                _createClass(VirtualRenderer, [{
                    ...
                    key: "setThemeCss",
                    value: function setThemeCss(themeLink, href) {
...
System.register("es6/theme/twilight.js", [], function (_export) {
  "use strict";
  var isDark, cssClass, cssName;
  return {
    setters: [],
    execute: function () {
      isDark = true;

      _export("isDark", isDark);

      cssClass = "ace-twilight";

      _export("cssClass", cssClass);

      cssName = "geometryzen/ace2016/theme/twilight.css";

      _export("cssName", cssName);
    }
  };
});
System.register("es6/ace.js", ["es6/lib/dom.js", "es6/lib/event.js", "es6/Editor.js", "es6/Document.js", "es6/EditSession.js", "es6/UndoManager.js", "es6/VirtualRenderer.js", "es6/theme/twilight.js"], function (_export) {
    "use strict";

    var getInnerText, addListener, removeListener, Editor, Document, EditSession, UndoManager, VirtualRenderer, isDark, cssClass;

    _export("edit", edit);

    _export("createEditSession", createEditSession);
    ...
    return {
        setters: [function (_es6LibDomJs) {
            getInnerText = _es6LibDomJs.getInnerText;
        }, function (_es6LibEventJs) {
            addListener = _es6LibEventJs.addListener;
            removeListener = _es6LibEventJs.removeListener;
        }, function (_es6EditorJs) {
            Editor = _es6EditorJs["default"];
        }, function (_es6DocumentJs) {
            Document = _es6DocumentJs["default"];
        }, function (_es6EditSessionJs) {
            EditSession = _es6EditSessionJs["default"];
        }, function (_es6UndoManagerJs) {
            UndoManager = _es6UndoManagerJs["default"];
        }, function (_es6VirtualRendererJs) {
            VirtualRenderer = _es6VirtualRendererJs["default"];
        }, function (_es6ThemeTwilightJs) {
            isDark = _es6ThemeTwilightJs.isDark;
            cssClass = _es6ThemeTwilightJs.cssClass;
        }],
        execute: function () {
            ;
