...
// FIXME: Decouple from TypeScript
/**
 ...
 */
export default function autoComplete(editor: ace.Editor, fileNameProvider: () => string, completionService: CompletionService) {
    /**
     ...
     *
     */
    var _handler: any = new ace.HashHandler();
    ...
    _handler.addCommands({
        ...
        insert: function(editor: ace.Editor) {
            editor.off("change", onEditorChange);
     ...
     */
    function activateUsingCursor(cursor: ace.Position) {
